      ...
      <macrolist>
         <macro id = "cabecera">
            <table width="100%"  style= "font-size: 8px;">
               <tr>
                  <td colspan="3" align="center" style= "font-weight: bold;">FORMATO 3.1: LIBRO CAJA Y BANCOS - DETALLE DE LOS MOVIMIENTOS DE LA CUENTA CORRIENTE</td>
               </tr>
               <tr>
      ...
      <table style="font-family: Verdana, Arial, Helvetica, sans-serif; width:100%" writing-mode="lr">
        ...
        <#list movements as key,mov>
            <tr>
               ...
               <td align = "center ">${mov.dato3}</td>
               <td align = "center ">${mov.dato4}</td>
               <td align = "center ">${mov.dato5}</td>
               <td align = "center ">${mov.dato8}</td>
               <td align = "center ">${mov.dato9}</td>
            </tr>
         </#list>
          <tr>
              <td align = "right " style= "font-weight:bold; border-top:1px solid black">${total.saldoDeudor}</td>
              <td align = "right " style= "font-weight:bold; border-top:1px solid black">${total.saldoAcreedor}</td>
          </tr> 
