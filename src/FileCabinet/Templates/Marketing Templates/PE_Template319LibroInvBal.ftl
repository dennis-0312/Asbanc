   ...
   <head>
    ...
    <body background-color="white" font-size="8" size="A4-landscape" header = "cabecera" header-height="25mm" footer-height="10mm">
       <table style="font-family: Verdana, Arial, Helvetica, sans-serif; width:100%" >
            <tr>
               <td width="25%" align = "center " style= "border:1px solid black; font-weight:bold">CUENTAS PATRIMONIALES</td>
               <td width="25%" align = "center " style= "border:1px solid black; font-weight:bold">CAPITAL</td>
               <#--  <td width="25%" align = "center " style= "border:1px solid black; font-weight:bold">TOTAL</td>  -->
            </tr>
            <#list movements as key,mov>
                <tr>
                    <td width="25%" style= "border-right:1px solid black" align = "left">${mov.dato1}</td>
                    <td width="25%" style= "border-right:1px solid black" align = "center">${mov.dato2}</td>
                </tr>
            </#list>
             <tr>
                  <td width="25%" style= "border:1px solid black; font-weight:bold" align = "right">${totals.dato3}</td>
               </tr>
        </table>
    </body>
</pdf>