    ...
    <body background-color="white" font-size="8" size="A4-landscape" header = "cabecera" header-height="25mm" footer-height="10mm">
        <table style="font-family: Verdana, Arial, Helvetica, sans-serif; width:100%" >
            <tr>
                ...
                <td width="25%" align = "center " style= "border:1px solid black; font-weight:bold; vertical-align: middle">FECHA DE ENTREGA O DEVOLUCIÓN</td>
            ...
            <#list movements as key,mov>
                <tr>
                    ...
                    <td width="25%" align = "center">${mov.fechaEntDev}</td>
                    <td width="25%" align = "center">${mov.tipoDoc}</td>
