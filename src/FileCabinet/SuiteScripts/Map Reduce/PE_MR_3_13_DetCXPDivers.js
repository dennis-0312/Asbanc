...
define(["N/runtime", "N/search", "N/config", "N/render", "N/record", "N/file", "../Library/PE_LIB_Libros.js"], (runtime, search, config, render, record, file, libPe) => {
  ...
  const summarize = (context) => {
    ...
    pGloblas["pRecordID"] = libPe.createLog(pGloblas.pSubsidiary, pGloblas.anioCon, "Formato3.13");
  ...
  const saveFile = (stringValue) => {
    ...
    var urlfile = "";
    if (featSubsidiary) {
      // nameReport = "Formato 3.13_" + companyName + "_" + fechaHoraGen + "." + formatReport;
      nameReport = "Formato 3.13_" + companyName + "." + formatReport;
    } else {
      nameReport = "Formato 3.13_" + "_" + fechaHoraGen + "." + formatReport;
    }
  ...
  const getTemplate = () => {
    var aux = file.load("../FTL/PE_Template_3_13_DetCXPDivers.xml");
  ...
  const getTransactions = () => {
    ...
    var savedSearch = search.load({
      id: "customsearch_asb_3_3_libro_impreso_2_2_6",
    });
