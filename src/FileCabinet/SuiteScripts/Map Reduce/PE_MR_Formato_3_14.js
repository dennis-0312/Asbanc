...
define(['N/runtime', 'N/search', 'N/config', 'N/render', 'N/record', 'N/file', '../Library/PE_LIB_Libros.js'], (runtime, search, config, render, record, file, libPe) => {
    ...
    const summarize = (context) => {
        ...
        getParameters();
        getSubdiary();
        pGloblas['pRecordID'] = libPe.createLog(pGloblas.pSubsidiary, pGloblas.pPeriod, "Caja y Banco 3.14")
        var transactionJSON = {};
    ...
    const getJsonData = (transactions) => {
        ...
        let jsonAxiliar = {
            ...
            "total": {
                "dato4": numberWithCommas(parseFloat(suma)),
            },
    ...
    const getTemplate = () => {
        ...
        var aux = file.load("../FTL/PE_Template_Formato_3_14.ftl");
    ...
    const getTransactions = () => {
        ...
        var savedSearch = search.load({
            id: 'customsearch_asb_3_14_libro_impreso'
        });
