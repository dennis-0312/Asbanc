                        ...
                        if (concepto_retencion ) {
                            ...
                            if (concepto_retencion != CONCEPTO_SIN_DETRACCION) {
                                ...
                                if (details_expense > 0) {
                                   ...
                                   log.debug('Hola amigos', roundTwoDecimal(amount_line_ret_expense) + ' -> ' + UNDEF_PE + ' -> '+ recordLoad.getSublistValue({ sublistId: GASTO, fieldId: 'department', line: 0 }) + ' -> ' +  recordLoad.getSublistValue({ sublistId: GASTO, fieldId: 'class', line: 0 }))
