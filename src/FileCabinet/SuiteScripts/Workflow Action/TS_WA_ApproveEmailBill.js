 ...
 * GAP 18        03 Jul 2023     Jeferson Mejía <jeferson.mejia@myevol.biz>     - Email Aprobado Workflow Aprobación de Factura
 */
...
define(['N/runtime', 'N/url', '../Library/TS_LIB_Email.js', '../Library/TS_LIB_Data.js'], function (runtime, url, libEmail, libData) {
  ...
  const onAction = (context) => {
    ...
    try {
      ...
      let subject = 'FACTURA: ' + tranID + ' APROBADA';
      let body = '<p>Buen día,<br><br>Usted tiene una Factura Aprobada:<br><br>Proveedor: ' + vendor + '<br><br>Monto: ' + formattedNumber + '<br><br>Moneda: ' + moneda + '<br><br>Se adjunta link para su aprobación.<br><br>Gracias.</p>';
