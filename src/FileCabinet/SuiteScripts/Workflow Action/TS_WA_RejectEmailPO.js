...
define(['N/runtime', 'N/url', '../Library/TS_LIB_Email.js', '../Library/TS_LIB_Data.js'], function (runtime, url, libEmail, libData) {
  ...
  const onAction = (context) => {
    ...
    try {
      ...
      let empleadoID = currentRecord.getValue('employee');
      ...
      let subject = 'ORDEN DE COMPRA: ' + tranID + ' RECHAZADA';
      let body = '<p>Buen día,<br><br>Usted tiene una Orden de Compra Rechazada:<br><br>Proveedor: ' + vendor + '<br><br>Monto: ' + formattedNumber + '<br><br>Moneda: ' + moneda + '<br><br>Motivo de Rechazo: ' + motivo_rechazo + '<br><br>Se adjunta link para su aprobación.<br><br>Gracias.</p>';
