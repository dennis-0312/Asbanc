...
define(['N/runtime', 'N/url', '../Library/TS_LIB_Email.js', '../Library/TS_LIB_Data.js'], function (runtime, url, libEmail, libData) {
  ...
  const onAction = (context) => {
    ...
    try {
      ...
      let subject = 'ORDEN DE COMPRA: ' + tranID + ' APROBADA';
      let body = '<p>Buen día,<br><br>Usted tiene una Orden de Compra Aprobada:<br><br>Proveedor: ' + vendor + '<br><br>Monto: ' + formattedNumber + '<br><br>Moneda: ' + moneda + '<br><br>Se adjunta link para su aprobación.<br><br>Gracias.</p>';
