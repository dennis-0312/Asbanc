...
define(['N/runtime', 'N/search', 'N/config', 'N/render', 'N/record', 'N/file', '../Library/PE_LIB_Libros.js'], (runtime, search, config, render, record, file, libPe) => {
    ...
    const summarize = (context) => {
        ...
        // generateLog();
        getSubdiary();
        pGloblas['pRecordID'] = libPe.createLog(pGloblas.pSubsidiary, pGloblas.pPeriod, "Caja y Banco 3.1")
    ...
    const getTemplate = () => {
        ...
        var aux = file.load("../TestScript/PE_Template_Formato_3_1.ftl");
    ...
    const getTransactions = () => {
        ...
        var savedSearch = search.load({
            id: 'customsearch_asb_3_1_libro_impreso'
        });
