   ...
   <body background-color="white" font-size="6" size="A4" header="cabecera" header-height="30mm">
      <table style="font-family: Verdana, Arial, Helvetica, sans-serif; width:100%" writing-mode="lr">
        ...
        <#list movements as key,mov>
          ...
          <tr>
              <td align = "right " style= "font-weight:bold; border-top:1px solid black">${total.contableIntangible}</td>
              <td align = "right " style= "font-weight:bold; border-top:1px solid black">${total.amortizacionAcumulada}</td>
              <td align = "right " style= "font-weight:bold; border-top:1px solid black">${total.netoContable}</td>
          </tr> 
