...
define(['N/runtime', 'N/search', 'N/config', 'N/render', 'N/record', 'N/file', '../Library/PE_LIB_Libros.js'], (runtime, search, config, render, record, file, libPe) => {
    ...
    const summarize = (context) => {
        ...
        // generateLog();
        getSubdiary();
        pGloblas['pRecordID'] = libPe.createLog(pGloblas.pSubsidiary, pGloblas.pPeriod, "Caja y Banco 3.24")
    ...
    const getJsonData = (transactions) => {
        ...
        let jsonAxiliar = {
            "company": {
                ...
                "thirdTitle": 'FORMATO 3.24 - ' + periodSearch.periodname,
            },
            "cabecera": {
    ...
    const getTemplate = () => {
        ...
        var aux = file.load("../TestScript/PE_Template_Formato_3_24.ftl");
    ...
    const getTransactions = () => {
        ...
        var savedSearch = search.load({
            id: 'customsearch_asb_3_24_libro_impreso'
        });
    ...
    const getParameters = () => {
        pGloblas = objContext.getParameter('custscript_pe_formato_3_24_params');
