...
define(['N/runtime', 'N/search', 'N/config', 'N/render', 'N/record', 'N/file', '../Library/PE_LIB_Libros.js'], (runtime, search, config, render, record, file, libPe) => {
    ...
    const summarize = (context) => {
        ...
        // generateLog();
        getSubdiary();
        pGloblas['pRecordID'] = libPe.createLog(pGloblas.pSubsidiary, pGloblas.pPeriod, "Caja y Banco 3.25")
    ...
    const saveFile = (stringValue) => {
        ...
        nameReport = 'LE' + fedIdNumb + periodostring + '010200' + '00' + '1' + asinfo + '11_XX' + pGloblas.pRecordID + '.pdf';
    ...
    const getTemplate = () => {
        ...
        var aux = file.load("../TestScript/PE_Template_Formato_3_25.ftl");
    ...
    const getTransactions = () => {
        ...
        var savedSearch = search.load({
            id: 'customsearch_asb_3_25_libro_impreso'
        });
