...
define(['N/runtime', 'N/search', 'N/config', 'N/render', 'N/record', 'N/file', '../Library/PE_LIB_Libros.js'], (runtime, search, config, render, record, file, libPe) => {
    ...
    const summarize = (context) => {
        ...
        // generateLog();
        getSubdiary();
        pGloblas['pRecordID'] = libPe.createLog(pGloblas.pSubsidiary, pGloblas.anioCon, "Formato7.1")
    ...
    const getJsonData = (transactions) => {
        ...
        for (var k in transactions) {
            ...
            if (!jsonTransacion[IDD]) {
                jsonTransacion[IDD] = {
                    ...
                    col_15: transactions[k].col_15,
                    col_16: transactions[k].col_16,
                    col_17: transactions[k].col_17,
                    col_18: transactions[k].col_18,
                    col_19: transactions[k].col_19,
                    col_20: transactions[k].col_20,
                    col_21: transactions[k].col_21,
                    col_22: transactions[k].col_22,
                    col_23: transactions[k].col_23,
                    col_24: transactions[k].col_24,
                    col_25: transactions[k].col_25,
                    col_26: transactions[k].col_26,
                    col_27: transactions[k].col_27,
                    col_28: transactions[k].col_28,
                    col_29: transactions[k].col_29,
                    col_30: transactions[k].col_30,
        ...
        let jsonAxiliar = {
            ...
            "total": {
                "totalMonto_15": totalMonto_15.toFixed(2),
                "totalMonto_16": totalMonto_16.toFixed(2),
                "totalMonto_17": totalMonto_17.toFixed(2),
                "totalMonto_18": totalMonto_18.toFixed(2),
                "totalMonto_19": totalMonto_19.toFixed(2),
                "totalMonto_20": totalMonto_20.toFixed(2),
                "totalMonto_21": totalMonto_21.toFixed(2),
                "totalMonto_22": totalMonto_22.toFixed(2),
                "totalMonto_23": totalMonto_23.toFixed(2),
                "totalMonto_28": totalMonto_28.toFixed(2),
                "totalMonto_29": totalMonto_29.toFixed(2),
                "totalMonto_30": totalMonto_30.toFixed(2),
            },
    ...
    const getTemplate = () => {
        ...
        var aux = file.load("../FTL/PE_Template71ActivoFijo.xml");
    ...
    const getTransactions = () => {
        ...
        var savedSearch = search.load({
            id: 'customsearch_pe_reg_activofijos_7_1'
        });
