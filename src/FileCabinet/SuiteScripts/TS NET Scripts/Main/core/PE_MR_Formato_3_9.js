...
define(['N/runtime', 'N/search', 'N/config', 'N/render', 'N/record', 'N/file', '../Library/PE_LIB_Libros.js'], (runtime, search, config, render, record, file, libPe) => {
    ...
    const summarize = (context) => {
        ...
        getParameters();
        getSubdiary();
        pGloblas['pRecordID'] = libPe.createLog(pGloblas.pSubsidiary, pGloblas.pPeriod, "Caja y Banco 3.9")
        var transactionJSON = {};
    ...
    const getJsonData = (transactions) => {
        ...
        for (var k in transactions) {
            ...
            if (!jsonTransacion[IDD]) {
                ...
                contableIntangible += dato_4;
                amortizacionAcumulada += dato_5;
                netoContable += dato_6;
        ...
        contableIntangible = contableIntangible.toFixed(2);
        amortizacionAcumulada = amortizacionAcumulada.toFixed(2);
        netoContable = netoContable.toFixed(2);
        let jsonAxiliar = {
            "company": {
            ...
            "total": {
                "contableIntangible": numberWithCommas(parseFloat(contableIntangible)),
                "amortizacionAcumulada": numberWithCommas(parseFloat(amortizacionAcumulada)),
                "netoContable": numberWithCommas(parseFloat(netoContable))
            },
    ...
    const getTemplate = () => {
        ...
        var aux = file.load("../TestScript/PE_Template_Formato_3_9.ftl");
    ...
    const getTransactions = () => {
        ...
        var savedSearch = search.load({
            id: 'customsearch_pe_detalle_34_3_9_2'
        });
