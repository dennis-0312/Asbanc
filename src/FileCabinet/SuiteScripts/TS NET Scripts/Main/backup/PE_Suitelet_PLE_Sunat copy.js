        ...
        function onRequest(context) {
            ...
            try {
                ...
                if (context.request.method === 'GET') {
                    ...
                    if (selectRepo == 115) {
                        //  FORMATO 9.1 : "Anual: Libro de Registro de Consignaciones - Para el Consignador - 9.1"
                        try {
                            if (selectForm == 'PDF') {
                                let parametrosJson = {};
                                parametrosJson["recordID"] = 10;
                                ...
                                log.debug('Libro Electrónico', '9.1')
                            }
                        } catch (e) {
                            log.error({ title: 'Error', details: 'Error Libro: ' + selectRepo + ' - ' + e });
                        }
                    ...
                    if (selectRepo == 117) {
                        //  FORMATO 9.2 : "Anual: Libro de Registro de Consignaciones - Para el Consignatario - 9.2"
                        try {
                            if (selectForm == 'PDF') {
                                let parametrosJson = {};
                                parametrosJson["recordID"] = 10;
                                ...
                                log.debug('Libro Electrónico', '9.2')
                            }
                        } catch (e) {
                            log.error({ title: 'Error', details: 'Error Libro: ' + selectRepo + ' - ' + e });
                        }
